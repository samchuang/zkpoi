 ...
 *
 */
public class ZssXSSFChart extends POIXMLDocumentPart implements ChartInfo {
     ...
     */
    protected ZssXSSFChart(PackagePart part, PackageRelationship rel) throws IOException, XmlException {
        super(part, rel);
